...
const services = {
  ...
  industrial: {
    title: "Обслуживание промышленных систем",
    desc: "Профессиональное обслуживание промышленных чиллеров, VRV/VRF систем и центральных кондиционеров.",
    fullDesc: "Промышленные системы кондиционирования требуют особого подхода и регулярного профессионального обслуживания. Наши специалисты имеют опыт работы с чиллерами, центральными кондиционерами, VRV/VRF системами любых производителей. Проводим плановое ТО, диагностику и ремонт.",
    price: "от 5 000 ₽",
    features: [
      "Диагностика промышленного оборудования",
      "Обслуживание чиллеров и фанкойлов",
      "Обслуживание VRV/VRF систем",
      "Замена фильтров и хладагента",
      "Круглосуточный выезд аварийной службы",
    ],
  },
  "semi-industrial": {
    title: "Обслуживание полупромышленных систем",
    desc: "Обслуживание полупромышленных кондиционеров: кассетные, канальные, колонные и мульти-сплит системы.",
    fullDesc: "Полупромышленные системы (кассетные, канальные, колонные, потолочные) используются в офисах, магазинах и общественных помещениях. Они требуют регулярного технического обслуживания для поддержания эффективности и долговечности. Наши мастера проведут все необходимые работы.",
    price: "от 3 000 ₽",
    features: [
      "Обслуживание кассетных сплит-систем",
      "Обслуживание канальных кондиционеров",
      "Обслуживание колонных и напольных систем",
      "Чистка и дезинфекция всех типов блоков",
      "Замена фильтров и дренажных помп",
    ],
  },
  maintenance: {
    title: "Техническое обслуживание сплит-систем",
    desc: "Регулярное ТО сплит-систем: диагностика, чистка, проверка давления, заправка при необходимости.",
    fullDesc: "Регулярное техническое обслуживание — залог долгой и бесперебойной работы вашего кондиционера. Рекомендуем проводить ТО не реже одного раза в год перед началом сезона. В комплекс входит: диагностика всех узлов, чистка фильтров и теплообменников, проверка давления фреона, тестирование всех режимов.",
    price: "от 2 000 ₽",
    features: [
      "Полная диагностика системы",
      "Чистка фильтров и теплообменников",
      "Проверка давления и дозаправка фреона",
